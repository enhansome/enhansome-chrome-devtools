...
* [VS Code - Elements for Microsoft Edge](https://github.com/microsoft/vscode-edge-devtools) ⭐ 822 | 🐛 1,191 | 🌐 TypeScript | 📅 2026-02-14 - Elements panel inside VS Code.
...
* [ChromeDevTools/devtools-protocol](https://github.com/chromedevtools/devtools-protocol) ⭐ 1,532 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-15 - **Canonical location of the protocol JSON**. Issue tracker for protocol bugs. TypeScript types.
...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer/) ⭐ 95,462 | 🐛 261 | 🌐 TypeScript | 📅 2026-08-14 - Node.js offering a high-level API to control headless Chrome over the DevTools Protocol. See also [awesome-puppeteer](https://github.com/transitive-bullshit/awesome-puppeteer) ⭐ 2,566 | 🐛 25 | 📅 2024-07-19.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 94,531 | 🐛 144 | 🌐 TypeScript | 📅 2026-08-15 - Library to automate Chromium, Firefox and WebKit with a single API. Available for Node.js, Python, .Net, Java. See also [awesome-playwright](https://github.com/mxschmitt/awesome-playwright) ⭐ 1,555 | 🐛 2 | 📅 2026-08-12.

### Libraries for driving the protocol (or a layer above)

* Go: [chromedp](https://github.com/chromedp/chromedp) ⭐ 13,252 | 🐛 177 | 🌐 Go | 📅 2026-07-14 - High-level actions and tasks for driving browsers
...
* C#/.NET: [Puppeteer Sharp](https://github.com/hardkoded/puppeteer-sharp) ⭐ 3,914 | 🐛 10 | 🌐 C# | 📅 2026-08-14 - Puppeteer port
...
* PHP: [chrome-devtools-protocol](https://github.com/jakubkulhan/chrome-devtools-protocol) ⭐ 185 | 🐛 20 | 🌐 PHP | 📅 2026-08-15 - A PHP client library for the protocol.
...
* [BrowserBox](https://github.com/BrowserBox/BrowserBox) ⭐ 3,895 | 🐛 0 | 🌐 Shell | 📅 2026-08-13 - Embed Chrome in a web page, largely powered by DevTools and supporting multiuser browsing, remote DevTools, audio, and documents like `.docx`, `.pdf`, and more.
