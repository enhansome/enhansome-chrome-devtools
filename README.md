...
* [Puppeteer](https://github.com/GoogleChrome/puppeteer/) ⭐ 95,515 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-28 - Node.js offering a high-level API to control headless Chrome over the DevTools Protocol. See also [awesome-puppeteer](https://github.com/transitive-bullshit/awesome-puppeteer) ⭐ 2,572 | 🐛 26 | 📅 2024-07-19.
* [Playwright](https://github.com/microsoft/playwright) ⭐ 95,316 | 🐛 167 | 🌐 TypeScript | 📅 2026-08-29 - Library to automate Chromium, Firefox and WebKit with a single API. Available for Node.js, Python, .Net, Java. See also [awesome-playwright](https://github.com/mxschmitt/awesome-playwright) ⭐ 1,561 | 🐛 11 | 📅 2026-08-12.
...
* Go: [Rod](https://github.com/go-rod/rod) ⭐ 7,081 | 🐛 210 | 🌐 Go | 📅 2026-08-11
...
* Ruby: [Ferrum](https://github.com/route/ferrum) ⭐ 2,039 | 🐛 14 | 🌐 Ruby | 📅 2026-08-28 - high-level API to control Chrome in Ruby
...
* PHP: [chrome-devtools-protocol](https://github.com/jakubkulhan/chrome-devtools-protocol) ⭐ 185 | 🐛 20 | 🌐 PHP | 📅 2026-08-29 - A PHP client library for the protocol.
